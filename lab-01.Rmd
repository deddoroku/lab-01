...
**NA stand for Not Available; because of a logic error**
...
**na.rm = true removes the missing values prior to computation.**
...
the greater the amount of attraction the more reliable the inter-quartile estimate.
...
```{r Ex_m}
visitors_with_nations %>% 
summarise(proportion = mean(admission == "Free"))
```
